...
43. When the mouse hovers over a monitor's value, display a short description of the monitor.
44. In Prefs, when I click up/down on a monitor in the list, the list gets reset and the selected monitor goes out of view. Make sure the vertical position of the selected monitor doesn't change - or at least is as close to the previous position as possible.
