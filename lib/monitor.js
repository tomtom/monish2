 ...
 * schema addition (e.g. intervalExpression added in ISSUE 93, actions.guard
 * added in ISSUE 64) can still be opened in the edit dialog without crashing.
...
export function normalizeMonitor(m) {
    ...
    return {
        ...
        intervalExpression: m.intervalExpression ?? '',
